...
#Returns worksheet connection for later use
    ...
    sheet = client.open("Streamlit_login_track").worksheet("Sheet1")
...
#Shows logged-in user name.
    ...
    # App Title
    st.title("English News Story Rating Prediction based on AI model")

    #define dropdown choices visible in UI.
    # ----------------------------------------
    # 5. Define Dropdown Input Options
    # ----------------------------------------
    genre_options = ["BUSINESS/FINANCE", "CAREER/EDUCATION", "CRIME/LAW & ORDER", "ELECTIONS", "ENTERTAINMENT", "EVENT/CELEBRATION/AWARDS", "HEALTH",
                 "INDIA-PAK","INTERNATIONAL", "MISHAPS/FAILURE OF MACHINERY", "MODI VISIT","NATIONAL THREAT/DEFENCE NEWS", "POLITICAL", 
                 "RELIGIOUS/FAITH", "SCIENCE/SPACE", "SPORTS", "TECHNOLOGY/GADGET", "VIRAL VIDEOS", "WAR", "WEATHER/ENVIRONMENT", "WILD LIFE"]

    geography_options = ["NATIONAL", "INTERNATIONAL", "ANDHRA PRADESH/TELANGANA", "BIHAR/JHARKHAND", "DELHI", "GUJARAT", "HIMACHAL PRADESH", 
                     "JAMMU AND KASHMIR/LADAKH", "KARNATAKA", "KERALA", "MADHYA PRADESH/CHHATTISGARH", "MAHARASHTRA/GOA", "NORTH-EAST",
                     "ODISHA", "PUNJAB/HARYANA/CHANDIGARH", "RAJASTHAN", "TAMIL NADU", "UTTAR PRADESH/UTTARAKHAND", "WEST BENGAL"]

    popularity_options = ["H", "M", "L"]

    personality_genre_options = ["AAP", "ACTIVIST", "AIDMK", "AIMIM", "BJP", "BRS", "BUSINESS", "CPIM", "DMK", "ENTERTAINER", "INC", "INTERNATIONAL",
                             "JDS", "JDU", "JMM", "JSP", "LJP", "MNM", "MNS", "NC", "NCP", "OTHER", "RELIGIOUS", "RJD", "RLD", "RSS-VHP", "SP",
                             "SPORTS", "SS", "TDP", "TMC", "TVK", "YSRCP"]
...
#Better models influence prediction more
        ...
        # ----------------------------------------
        weights = [0.0967, 0.0978, 0.0991, 0.1049, 0.0986, 0.0966, 0.1026, 0.0993,0.1060, 0.0984]  # From your F1 scores
